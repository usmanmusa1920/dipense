...
# Insert DiPense' path into the system.
...
def grep(attrname):
    ...
    file_path = os.path.join(ORIGIN, 'library/dipense/__init__.py')
...
latex_documents = [
    (master_doc, 'DiPense.tex', 'DiPense Documentation',
     'Usman Musa', 'manual'),
]
...
man_pages = [
    (master_doc, 'dipense', 'DiPense Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DiPense', 'DiPense Documentation',
     author, 'DiPense', 'One line description of project.',
     'Miscellaneous'),
]
